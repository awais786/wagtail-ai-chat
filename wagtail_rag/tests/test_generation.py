...
class TestLLMGenerator(unittest.TestCase):
    ...
    def test_extract_text_from_result(self):
        ...
        self.assertEqual(LLMGenerator._extract_text_from_result(result), "Response content")
        
        # Direct string
        self.assertEqual(LLMGenerator._extract_text_from_result("Direct string"), "Direct string")
